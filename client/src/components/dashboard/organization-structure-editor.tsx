...
const getDivisionFromPosition = (position: string): string => {
	...
	const divisions = ['Senor', 'Public Relation', 'Religius', 'Technopreneurship', 'Medinfo', 'Intelektual'];
...
export default function OrganizationStructureEditor() {
	...
	const deleteMemberMutation = useMutation({
		...
		onError: () => toast({ title: 'Error', description: 'Failed to delete organization member', variant: 'destructive' }),
	});
	...
	const deletePeriodMutation = useMutation({
		...
		onError: () => toast({ title: 'Error', description: 'Failed to delete period', variant: 'destructive' }),
	});
	...
	const createDivisionMutation = useMutation({
		mutationFn: async (data: any) => apiRequest('POST', '/api/divisions', data),
		onSuccess: () => {
	...
	const updateDivisionMutation = useMutation({
		mutationFn: async ({ id, data }: { id: string; data: any }) => apiRequest('PUT', `/api/divisions/${id}`, data),
		onSuccess: () => {
			queryClient.invalidateQueries({ queryKey: ['/api/divisions'] });
			queryClient.invalidateQueries({ queryKey: ['/api/divisions/available-positions'] });
	...
	const deleteDivisionMutation = useMutation({
		...
		onError: () => toast({ title: 'Error', description: 'Failed to delete division', variant: 'destructive' }),
	});
