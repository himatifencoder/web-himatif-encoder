      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 sm:grid-cols-2 gap-8">
          <div>
            ...
            <p className="text-gray-400">Himpunan Mahasiswa Teknik Informatika UIN Maulana Malik Ibrahim Malang</p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href="https://uin-malang.ac.id" className="hover:text-white transition">UIN Malang</a></li>
              <li><a href="#" className="hover:text-white transition">Fakultas Sains dan Teknologi</a></li>
              <li><a href="#" className="hover:text-white transition">Jurusan Teknik Informatika</a></li>
              <li><a href="#" className="hover:text-white transition">Perpustakaan</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href={socialLinks.instagram} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
              ...
              <a href={socialLinks.youtube} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/>
                </svg>
              </a>
              <a href={socialLinks.facebook} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
