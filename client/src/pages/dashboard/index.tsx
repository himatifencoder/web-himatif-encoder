              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium text-sm">New article published</p>
                      <p className="text-gray-500 text-xs">5 minutes ago by {user?.name || user?.username}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium text-sm">Media files uploaded</p>
                      <p className="text-gray-500 text-xs">1 hour ago by Admin</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="font-medium text-sm">Organization updated</p>
                      <p className="text-gray-500 text-xs">3 hours ago by Owner</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-primary mb-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                    </svg>
