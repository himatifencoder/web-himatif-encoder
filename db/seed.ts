		...
		if (!existingOrgStructure) {
			...
			const organizationMembers = [
				...
				},
				{
					...
					period: '2023-2024',
					imageUrl:
						'https://images.unsplash.com/photo-1590031905470-a1a1feacbb0b?w=400&h=400&fit=crop',
				},
				{
					name: 'Budi Santoso',
			...
			if (adminUser && chairUser && developmentUser) {
				const sampleArticles = [
					{
						...
						excerpt:
							'Divisi Akademik mengadakan workshop Machine Learning bagi mahasiswa yang ingin memulai karir di bidang AI.',
              ...
              <p>Jangan lewatkan kesempatan berharga ini untuk meningkatkan skill dan kompetensi Anda di bidang yang sedang berkembang pesat ini!</p>`,
					...
					},
					{
						...
						excerpt:
							'Himpunan Informatika mengadakan kunjungan industri ke kantor Google Indonesia di Jakarta.',
              ...
              <p>Untuk informasi lebih lanjut, silakan hubungi panitia kunjungan industri melalui WhatsApp atau kunjungi sekretariat HMTI.</p>`,
						image:
							'https://images.unsplash.com/photo-1617042375876-a13e36732a04?w=600&auto=format&fit=crop',
						published: true,
					...
					},
					{
						...
						excerpt:
							'Divisi Pengembangan mengadakan webinar mengenai peluang karir di bidang keamanan siber.',
				...
				const sampleLibraryItems = [
					{
						...
						description:
							'Kumpulan foto kegiatan Kemah IT yang diadakan di Batu pada 20-22 Juli 2023.',
						fullDescription:
							'Dokumentasi lengkap kegiatan Kemah IT 2023 yang diadakan di Batu pada tanggal 20-22 Juli 2023. Kegiatan ini diikuti oleh 80 mahasiswa Teknik Informatika angkatan 2022 dan 15 panitia dari angkatan 2021. Acara ini bertujuan untuk mempererat tali persaudaraan dan mengasah softskill di bidang IT.',
						images: [
					...
					},
					{
						...
						description:
							'Video workshop UI/UX Design bersama praktisi dari Tokopedia.',
						fullDescription:
							'Video lengkap workshop UI/UX Design yang diadakan secara daring pada 8 Agustus 2023. Workshop ini menghadirkan pembicara Bapak Irfan Maulana, Senior UI/UX Designer dari Tokopedia, yang membagikan pengalaman dan tips dalam mendesain antarmuka pengguna yang efektif dan menarik.',
						images: [
					...
					},
					{
						...
						description:
							'Foto-foto keseruan Lomba Coding Competition tingkat universitas.',
						fullDescription:
							'Dokumentasi Lomba Coding Competition 2023 yang diselenggarakan oleh Himpunan Mahasiswa Teknik Informatika pada tanggal 3-4 September 2023. Lomba ini diikuti oleh 25 tim dari berbagai fakultas di UIN Malang, dengan total hadiah sebesar Rp 5.000.000. Tema lomba tahun ini adalah "Teknologi untuk Kesejahteraan Masyarakat".',
						images: [
